...
#############################################################################################
#############################################################################################
def build_meta_dict( samfile ):
	'''generate some VCF meta data as a dictionnary.
		INFO, FORMAT, FILTER
	'''
	...
	boolQuality = __get_quality_flag( samfile )
#sample ?
#ref ?
#filter
#info
#format
# l_samples = Gi pour chaque genotype
	d_meta = {
		'source': 'discoSNP'
		'reference': 'ref.fa',
...
# listName et boolmyname pas utilisés
